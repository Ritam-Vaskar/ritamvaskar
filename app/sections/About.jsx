...
const AboutMe = () => {
  ...
  const cvPreviewLink = "https://drive.google.com/file/d/1DSPH4kq--iCJUa3K8v_Rd4Y4TIHD1xiB/preview";
            ...
            <div className="relative w-[220px] h-[220px] border border-slate-700 p-3">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-[190px] h-[190px] overflow-hidden border border-slate-700">
                  <Image src="/WhatsApp%20Image%202026-05-14%20at%204.08.56%20PM.jpeg" alt="Ritam Vaskar Avatar" fill className="object-cover" priority />
                </div>
              </div>
            </div>
          </div>
