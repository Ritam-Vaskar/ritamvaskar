    ...
    <section className="relative min-h-screen w-full py-12 px-4 overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="max-w-6xl mx-auto ">
        ...
        <div className="relative flex">
          {/* Timeline Line */}
          <motion.div
            className="absolute left-[1.8rem] top-0 bottom-0 w-1 bg-gradient-to-b from-purple-500 to-indigo-500"
            initial={{ height: 0 }}
          ...
          <div className="ml-10 space-y-16 w-[80%] ">
            {educationData.map((edu, index) => (
              ...
              {/* Timeline Node */}
              <motion.div
                className="absolute left-[-20px] transform -translate-x-1/2 w-6 h-6 rounded-full bg-purple-500 z-10"
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
